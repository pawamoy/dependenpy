...
class MatricesTestCase(AbstractTestCase):
    ...
    #              'from': 'internal.submodule1.submoduleA.test',
    #              'import': ['Test1']},
    #             {'by': 'internal.submodule1.test', 'from': 'internal', 'import': ['test']},
...
class OutputTestCase(AbstractTestCase):
    ...
    def test_matrix_to_json(self):
        for dm in [self.str_dm, self.list_dm, self.od_dm]:
            for i in range(1, dm.max_depth):
                self.assertEqual(
                    dm.get_matrix(i),
                    json.loads(dm.get_matrix(i).to_json()),
                    'JSON MATRIX dump/load %s' % i
                )

    # def test_matrix_to_csv(self):
    #     for dm in [self.str_dm, self.list_dm, self.od_dm]:
    #         self.assertEqual(dm.get_matrix(1).to_csv(),
    #                          ',internal\r\n'
    #                          'internal,18',
    #                          'CSV MATRIX 1')
    #         self.assertEqual(dm.get_matrix(2).to_csv(),
    #                          ',internal.__init__,internal.submodule1,internal.submodule2,internal.test\r\n'
    #                          'internal.__init__,0,0,0,0\r\n'
    #                          'internal.submodule1,1,3,0,9\r\n'
    #                          'internal.submodule2,0,0,1,0\r\n'
    #                          'internal.test,1,2,1,0',
    #                          'CSV MATRIX 2')
    #         self.assertEqual(dm.get_matrix(3).to_csv(),
    #                          ',internal.__init__,internal.submodule1.__init__,internal.submodule1.submoduleA,internal.submodule1.test,internal.submodule2.__init__,internal.submodule2.test,internal.submodule2.test2,internal.test\r\n'
    ...
    #                          'CSV MATRIX 3')
    #         self.assertEqual(dm.get_matrix(4).to_csv(),
    #                          ',internal.__init__,internal.submodule1.__init__,internal.submodule1.submoduleA.__init__,internal.submodule1.submoduleA.test,internal.submodule1.test,internal.submodule2.__init__,internal.submodule2.test,internal.submodule2.test2,internal.test\r\n'
