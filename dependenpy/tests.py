        ...
        self.assertEqual(
            ...
            {'imports': [{'cardinal': 18,
               'imports': [{'by': 'internal.submodule2.test',
                 'from': 'internal.submodule2.test2',
                 'import': ['someclass']},
                {'by': 'internal.test', 'from': 'internal', 'import': ['submodule2']},
                {'by': 'internal.test',
                 'from': 'internal.submodule1',
                 'import': ['submoduleA']},
                {'by': 'internal.test',
        ...
        self.assertEqual(
            ...
            {'imports': [{'cardinal': 1,
              ...
              {'cardinal': 1,
               ...
               'target_index': 0,
               'target_name': 'internal.__init__'}],
             'modules': [{'group_index': 0, 'group_name': group, 'name': 'internal.__init__'},
              {'group_index': 0, 'group_name': group, 'name': 'internal.submodule2'},
              {'group_index': 0, 'group_name': group, 'name': 'internal.test'},
              {'group_index': 0, 'group_name': group, 'name': 'internal.submodule1'}]},
            'Depth 2 not equal')
        self.assertEqual(
            dm.get_matrix(3),
            {'imports': [{'cardinal': 1,
              ...
              {'cardinal': 1,
               ...
               'target_name': 'internal.__init__'}],
             'modules': [{'group_index': 0, 'group_name': group, 'name': 'internal.__init__'},
              {'group_index': 0, 'group_name': group, 'name': 'internal.submodule2.test2'},
              {'group_index': 0, 'group_name': group, 'name': 'internal.submodule2.__init__'},
              {'group_index': 0, 'group_name': group, 'name': 'internal.submodule2.test'},
              {'group_index': 0, 'group_name': group, 'name': 'internal.test'},
              {'group_index': 0, 'group_name': group, 'name': 'internal.submodule1.__init__'},
              {'group_index': 0,
               'group_name': group,
               'name': 'internal.submodule1.submoduleA'},
              {'group_index': 0, 'group_name': group, 'name': 'internal.submodule1.test'}]},
            'Depth 3 not equal')
        self.assertEqual(
            dm.get_matrix(4),
            {'imports': [{'cardinal': 1,
    ...
    def test_matrix_to_csv(self):
        for dm in [self.str_dm, self.list_dm, self.od_dm]:
            ...
            self.assertEqual(dm.matrix_to_csv(2),
                             ',internal.__init__,internal.submodule2,internal.test,internal.submodule1\r\n'
                             'internal.__init__,0,0,0,0\r\n'
                             'internal.submodule2,0,1,0,0\r\n'
                             'internal.test,1,1,0,2\r\n'
                             'internal.submodule1,1,0,9,3',
                             'CSV MATRIX 2')
            self.assertEqual(dm.matrix_to_csv(3),
                             ',internal.__init__,internal.submodule2.test2,internal.submodule2.__init__,internal.submodule2.test,internal.test,internal.submodule1.__init__,internal.submodule1.submoduleA,internal.submodule1.test\r\n'
                             ...
                             'internal.test,1,0,1,0,0,1,1,0\r\n'
                             'internal.submodule1.__init__,0,0,0,0,0,0,0,0\r\n'
                             'internal.submodule1.submoduleA,0,0,0,0,9,0,0,0\r\n'
                             'internal.submodule1.test,1,0,0,0,0,0,3,0',
                             'CSV MATRIX 3')
            self.assertEqual(dm.matrix_to_csv(4),
                             ',internal.__init__,internal.submodule2.test2,internal.submodule2.__init__,internal.submodule2.test,internal.test,internal.submodule1.__init__,internal.submodule1.submoduleA.__init__,internal.submodule1.submoduleA.test,internal.submodule1.test\r\n'
                             ...
                             'internal.test,1,0,1,0,0,1,1,0,0\r\n'
                             'internal.submodule1.__init__,0,0,0,0,0,0,0,0,0\r\n'
                             'internal.submodule1.submoduleA.__init__,0,0,0,0,0,0,0,0,0\r\n'
                             'internal.submodule1.submoduleA.test,0,0,0,0,9,0,0,0,0\r\n'
                             'internal.submodule1.test,1,0,0,0,0,0,2,1,0',
                             'CSV MATRIX 4')
